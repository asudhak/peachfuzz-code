 ...
 *
 * {A62C2601-B414-3F36-83A1-826978673595}
 */
static const GUID EngineGuid = {0xa62c2601, 0xb414, 0x3f36, {0x83, 0xa1, 0x82, 0x69, 0x78, 0x67, 0x35, 0x95}};
 ...
 * for the benefit of automated scripts.
 *
 * {4CBD32DF-386C-3286-8A18-9B1315AA72F2}
 */
static const GUID BaseDebugMonitorGuid = {0x4cbd32df, 0x386c, 0x3286, {0x8a, 0x18, 0x9b, 0x13, 0x15, 0xaa, 0x72, 0xf2}};
...
enum CUSTOM_MESSAGE_TYPE
{
    ...
    /*!
     * An VS service or another debugger component can send this custom
