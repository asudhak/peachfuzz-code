 ...
 * Direct access to all context registers is now available using PIN_SetContextRegVal.
 */
extern PIN_DEPRECATED_API VOID PIN_SetContextFPState(CONTEXT * ctxt, const VOID * fpstate);

                                                                  /* DO NOT EDIT */
/* DO NOT EDIT */
/* PIN_SetContextFPState(CONTEXT * ctxt, const FPSTATE * fpstate) is now deprecated.
 * Direct access to all context registers is now available using PIN_SetContextRegVal.
 */
extern PIN_DEPRECATED_API VOID PIN_SetContextFPState(CONTEXT * ctxt, const FPSTATE * fpstate);

                                                                  /* DO NOT EDIT */
/* DO NOT EDIT */
/* PIN_GetContextFPState(const CONTEXT * ctxt, VOID * fpstate) is now deprecated.
 * Direct access to all context registers is now available using PIN_GetContextRegVal.
 */
extern PIN_DEPRECATED_API VOID PIN_GetContextFPState(const CONTEXT * ctxt, VOID * fpstate);

                                                                  /* DO NOT EDIT */
/* DO NOT EDIT */
/* PIN_GetContextFPState(const CONTEXT * ctxt, FPSTATE * fpstate) is now deprecated.
 * Direct access to all context registers is now available using PIN_GetContextRegVal.
 */
extern PIN_DEPRECATED_API VOID PIN_GetContextFPState(const CONTEXT * ctxt, FPSTATE * fpstate);
