namespace Peach.Core.Debuggers.DebugEngine.Tlb
{
    ...
    [ComImport, InterfaceType((short) 1), Guid("7DF74A86-B03F-407F-90AB-A20DADCEAD08")]
    public interface IDebugControl3
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void Output([In] uint Mask, [In] ref sbyte Format, [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType=VarEnum.VT_VARIANT)] object[] __MIDL__IDebugControl30000);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void OutputVaList([In] uint Mask, [In] ref sbyte Format, [In] ref sbyte Args);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void ControlledOutput([In] uint OutputControl, [In] uint Mask, [In] ref sbyte Format, [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType=VarEnum.VT_VARIANT)] object[] __MIDL__IDebugControl30001);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void ControlledOutputVaList([In] uint OutputControl, [In] uint Mask, [In] ref sbyte Format, [In] ref sbyte Args);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void OutputPrompt([In] uint OutputControl, [In, Optional] ref sbyte Format, [Optional, MarshalAs(UnmanagedType.SafeArray, SafeArraySubType=VarEnum.VT_VARIANT)] object[] __MIDL__IDebugControl30002);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
