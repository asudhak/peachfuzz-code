namespace Peach.Core.Debuggers.DebugEngine.Tlb
{
    ...
    [ComImport, Guid("5182E668-105E-416E-AD92-24EF800424BA"), InterfaceType((short) 1)]
    public interface IDebugControl
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void Output([In] uint Mask, [In] ref sbyte Format, [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType=VarEnum.VT_VARIANT)] object[] __MIDL__IDebugControl0000);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void OutputVaList([In] uint Mask, [In] ref sbyte Format, [In] ref sbyte Args);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void ControlledOutput([In] uint OutputControl, [In] uint Mask, [In] ref sbyte Format, [MarshalAs(UnmanagedType.SafeArray, SafeArraySubType=VarEnum.VT_VARIANT)] object[] __MIDL__IDebugControl0001);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void ControlledOutputVaList([In] uint OutputControl, [In] uint Mask, [In] ref sbyte Format, [In] ref sbyte Args);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void OutputPrompt([In] uint OutputControl, [In, Optional] ref sbyte Format, [Optional, MarshalAs(UnmanagedType.SafeArray, SafeArraySubType=VarEnum.VT_VARIANT)] object[] __MIDL__IDebugControl0002);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
