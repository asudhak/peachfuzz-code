namespace PeachFileFuzzer
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.radioButtonStrategySequencial = new System.Windows.Forms.RadioButton();
			this.radioButtonStrategyRandom = new System.Windows.Forms.RadioButton();
			...
			// groupBox5
			// 
			this.groupBox5.Controls.Add(this.radioButtonStrategySequencial);
			this.groupBox5.Controls.Add(this.radioButtonStrategyRandom);
			this.groupBox5.Location = new System.Drawing.Point(115, 130);
			this.groupBox5.Name = "groupBox5";
			this.groupBox5.Size = new System.Drawing.Size(293, 52);
			this.groupBox5.TabIndex = 11;
			this.groupBox5.TabStop = false;
			this.groupBox5.Text = "Fuzzing Strategy";
			// 
			// radioButtonStrategySequencial
			// 
			this.radioButtonStrategySequencial.AutoSize = true;
			this.radioButtonStrategySequencial.Location = new System.Drawing.Point(149, 19);
			this.radioButtonStrategySequencial.Name = "radioButtonStrategySequencial";
			this.radioButtonStrategySequencial.Size = new System.Drawing.Size(78, 17);
			this.radioButtonStrategySequencial.TabIndex = 1;
			this.radioButtonStrategySequencial.TabStop = true;
			this.radioButtonStrategySequencial.Text = "Sequencial";
			this.radioButtonStrategySequencial.UseVisualStyleBackColor = true;
			// 
			// radioButtonStrategyRandom
			// 
			this.radioButtonStrategyRandom.AutoSize = true;
			this.radioButtonStrategyRandom.Location = new System.Drawing.Point(47, 19);
			this.radioButtonStrategyRandom.Name = "radioButtonStrategyRandom";
			this.radioButtonStrategyRandom.Size = new System.Drawing.Size(65, 17);
			this.radioButtonStrategyRandom.TabIndex = 0;
			this.radioButtonStrategyRandom.TabStop = true;
			this.radioButtonStrategyRandom.Text = "Random";
			this.radioButtonStrategyRandom.UseVisualStyleBackColor = true;
			// 
			// button3
			// 
		...
		private System.Windows.Forms.RadioButton radioButtonStrategySequencial;
		private System.Windows.Forms.RadioButton radioButtonStrategyRandom;
