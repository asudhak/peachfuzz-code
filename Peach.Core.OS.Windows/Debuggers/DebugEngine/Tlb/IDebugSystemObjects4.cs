namespace Peach.Core.Debuggers.DebugEngine.Tlb
{
    ...
    [ComImport, Guid("489468E6-7D0F-4AF5-87AB-25207454D553"), InterfaceType((short) 1)]
    public interface IDebugSystemObjects4
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void GetCurrentProcessExecutableNameWide([Optional] out ushort Buffer, [In, Optional] uint BufferSize, [Optional] out uint ExeSize);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
        void GetCurrentSystemServerNameWide([Optional] out ushort Buffer, [In, Optional] uint BufferSize, [Optional] out uint NameSize);
    }
}
