...
namespace Peach.Core.Test.Mutators
{
    ...
    class UnicodeBadUtf8MutatorTests : DataModelCollector
    {
        ...
        public void Test1()
        {
            ...
            Assert.AreEqual(val1, ((BitwiseStream)mutations[0]).ToArray());
            Assert.AreEqual(val2, ((BitwiseStream)mutations[1]).ToArray());
            Assert.AreEqual(val3, ((BitwiseStream)mutations[mutations.Count - 2]).ToArray());
            Assert.AreEqual(val4, ((BitwiseStream)mutations[mutations.Count - 1]).ToArray());
        }
    }
}
